...
import { ChevronLeft, ChevronRight, LogOut, Calendar as CalendarIcon, Plus, Eye, List, Grid, X } from 'lucide-react';
...
const EventsContent = ({ events, onDeleteEvent }: EventsContentProps) => (
...
const CalendarComponent = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-background via-background to-primary/5 p-3 sm:p-4 md:p-8">
      <div className="max-w-7xl mx-auto h-[calc(100vh-2rem)] sm:h-[calc(100vh-4rem)] flex flex-col">
        ...
        <header className="flex items-center justify-between mb-4 sm:mb-6">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              <h1 className="text-md sm:text-xl md:text-2xl font-bold">Demanual AI Event Manager</h1>
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <Button variant="outline" onClick={handleLogout} className="transition-smooth cursor-pointer">
          ...
          <SheetContent aria-describedby={undefined} side={isDesktop ? "right" : "bottom"} className={cn(
            ...
            <div className={cn(
              ...
              <ScrollArea className="h-full pr-4">
                <EventsContent events={allEvents} onDeleteEvent={deleteEvent} />
              </ScrollArea>
            </div>
          </SheetContent>
        </Sheet>
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogContent aria-describedby={undefined} className="glass max-w-md ">
            <DialogHeader>
            ...
            <div className="space-y-4">
              ...
              <Button onClick={handleAddEvent} className="w-full transition-smooth cursor-pointer">
                Add Event
              </Button>
            </div>
          </DialogContent>
